...
-type pool(IQY, IQZ) :: {pool,
        fun((IQY, glisten@internal@handler:loop_message(IQZ), glisten@internal@handler:connection(IQZ)) -> glisten@internal@handler:next(IQY, glisten@internal@handler:loop_message(IQZ))),
        integer(),
        fun((glisten@internal@handler:connection(IQZ)) -> {IQY,
            gleam@option:option(gleam@erlang@process:selector(IQZ))}),
        gleam@option:option(fun((IQY) -> nil)),
        glisten@transport:transport()}.
