...
-spec set_allowed_origin(cors(), binary()) -> fun((gleam@http@response:response(RIW)) -> gleam@http@response:response(RIW)).
...
-spec set_expose_headers(gleam@http@response:response(RFI), cors()) -> gleam@http@response:response(RFI).
...
-spec set_max_age(gleam@http@response:response(RFL), cors()) -> gleam@http@response:response(RFL).
...
-spec set_allow_credentials(gleam@http@response:response(RFO), cors()) -> gleam@http@response:response(RFO).
...
-spec set_allow_methods(gleam@http@response:response(RFS), cors()) -> gleam@http@response:response(RFS).
...
-spec set_allow_headers(gleam@http@response:response(RFV), cors()) -> gleam@http@response:response(RFV).
...
-spec set_response(
    gleam@http@response:response(RFY),
    cors(),
...
-spec set_cors(gleam@http@response:response(RGC), cors()) -> gleam@http@response:response(RGC).
set_cors(Res, Cors) ->
...
-spec set_cors_multiple_origin(
    gleam@http@response:response(RGF),
    cors(),
    binary()
) -> gleam@http@response:response(RGF).
...
-spec middleware(
    RGL,
    gleam@http@request:request(RGM),
    cors(),
    fun((gleam@http@request:request(RGM)) -> gleam@http@response:response(RGL))
) -> gleam@http@response:response(RGL).
