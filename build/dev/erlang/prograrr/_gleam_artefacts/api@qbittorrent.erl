...
-export([get_torrents_with_auth/3]).
...
-file("src/api/qbittorrent.gleam", 80).
...
-file("src/api/qbittorrent.gleam", 61).
...
-file("src/api/qbittorrent.gleam", 50).
...
-file("src/api/qbittorrent.gleam", 15).
