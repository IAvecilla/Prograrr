...
?DOC(false).
-spec add_date_header(gleam@http@response:response(KLU)) -> gleam@http@response:response(KLU).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(KLX)) -> gleam@http@response:response(KLX).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(KMA)) -> gleam@http@response:response(KMA).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(KMD)) -> gleam@http@response:response(KMD).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(KMI)) -> gleam@http@response:response(KMI)).
