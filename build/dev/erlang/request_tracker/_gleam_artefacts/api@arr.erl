...
-spec queue_item_decoder(boolean()) -> gleam@dynamic@decode:decoder(models@request:arr_queue_item()).
queue_item_decoder(_) ->
...
parse_queue_response(Body, Is_sonarr) ->
    Decoder = begin
        gleam@dynamic@decode:field(
            <<"records"/utf8>>,
            gleam@dynamic@decode:list(queue_item_decoder(Is_sonarr)),
