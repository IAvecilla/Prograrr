-module(request_tracker_test).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch, inline]).
-define(FILEPATH, "test/request_tracker_test.gleam").
-export([main/0, hello_world_test/0]).

-file("test/request_tracker_test.gleam", 3).
-spec main() -> nil.
main() ->
    gleeunit:main().

-file("test/request_tracker_test.gleam", 8).
...
hello_world_test() ->
    ...
    case Greeting =:= _assert_subject of
        ...
        false -> erlang:error(#{gleam_error => assert,
                ...
                file => <<?FILEPATH/utf8>>,
                module => <<"request_tracker_test"/utf8>>,
